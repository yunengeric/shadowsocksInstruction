...
![alt text](images/shadowsockDownload-mac.PNG)

### 2. Install the client

Double-click on "ShadowsocksX-NG.x.x.x.zip" to extract "ShadowsocksX-NG".

![Install the client](images/shadowsocksIcon-mac.png)

Move "ShadowsocksX-NG" to "Applications".

!["ShadowsocksX-NG" moves to "Apps"](images -en/shadowsocksDrag-mac.gif)
...
![Click on the menu bar](images -en/menubar-mac.png)
...
![Server Settings](images -en/shadowsocksSetting-mac.png)
...
![QR code setting](images -en/QR-mac.png)
...
![pac settings](images -en/pac-mac.png)
