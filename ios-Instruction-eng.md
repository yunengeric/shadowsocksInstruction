...
![View your node information. ](images -en/portal.png)
...
![Open Potatso Lite after installation from the App Store](images -en/step1-ios.png)

* Click "Get Started" > "Add Now".

![Use Now](images -en/step2-ios.png)
...
![Select QR Code](images -en/step3-ios.png)

**Manual configuration**

* Click "Add" > fill in the blank.

[manual proxy](images/step3-ios1.PNG)
...
![fills in the blank](images -en/step4-ios.png)
...
![Agent fills in](images -en/step5-ios.png)

![Agent fills in](images -en/step6-ios.png)

![Agent fills in](images -en/step7-ios.png)
